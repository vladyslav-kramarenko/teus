const newsData = [
    {
        ...
        description: "The partnership ag reement was signed in Antalya on 1 December 2023. In the photo, the founder and CEO of Teus Group Basel Huari and Regional Director of Best Western International in Turkey Semih Anilı are pictured. \n" +
            "Best Western representatives will manage the project after the complex is commissioned and manage the hotel property. Best Western is currently one of the ten largest hotel chains in the world. It manages more than 4,700 hotels. The company was founded in the 1940s in the United States (as, by the way, was Zhytlobud-2). In the DESIRE project, BWH representatives will not only lease out hotel properties, but will also become the management company for the entire complex. \n" +
